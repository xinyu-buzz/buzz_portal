...
const makeCourse = (id: string, title: string, daysOld: number, profile: any, hasStorage = true) => ({
  id,
  title,
...
const makeUnit = (id: string, title: string, daysOld: number, profile: any, hasStorage = true) => ({
  id,
  title,
  deleted_at: daysAgo(daysOld),
  deleted_by: "user-1",
...
const makeTest = (id: string, testName: string, daysOld: number, profile: any, hasStorage = true) => ({
  id,
  test_name: testName,
  deleted_at: daysAgo(daysOld),
  deleted_by: "user-1",
